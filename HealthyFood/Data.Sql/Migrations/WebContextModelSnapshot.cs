...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Interface.Models.WikiBlockImg", b =>
                {
                    ...
                    b.ToTable("WikiBlockImg", (string)null);
                });

            modelBuilder.Entity("Data.Interface.Models.WikiMc.WikiCalculationResults", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AverageCalculatedCalories")
                        .HasColumnType("int");

                    b.Property<int>("CalculatorUserId")
                        .HasColumnType("int");

                    b.Property<int>("GramsCarb")
                        .HasColumnType("int");

                    b.Property<int>("GramsFat")
                        .HasColumnType("int");

                    b.Property<int>("GramsProtein")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CalculatorUserId")
                        .IsUnique();

                    b.ToTable("WikiCalculationResults", (string)null);
                });
            ...
            modelBuilder.Entity("Data.Interface.Models.WikiMc.WikiTags", b =>
                {
                    ...
                    b.ToTable("WikiTags", (string)null);
                });
            ...
            modelBuilder.Entity("WikiMcImageWikiTags", b =>
                {
                    ...
                    b.ToTable("WikiMcImageWikiTags", (string)null);
                });
            ...
            modelBuilder.Entity("Data.Interface.Models.WikiMc.WikiCalculationResults", b =>
                {
                    b.HasOne("Data.Interface.Models.User", "CalculatorUser")
                        .WithOne("UserNutrients")
                        .HasForeignKey("Data.Interface.Models.WikiMc.WikiCalculationResults", "CalculatorUserId");

                    b.Navigation("CalculatorUser");
                });
